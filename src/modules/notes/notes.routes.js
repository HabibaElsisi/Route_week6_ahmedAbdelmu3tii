...
import { addNote, deleteNote, getAllNotes, getNotesForSpecificUser, getSingleNote, updateNote } from "./notes.controllers.js";
...
noteRouter.get("/allNotesForSpecificUser",protectedRoutes,allowedTo("user"),getNotesForSpecificUser)
noteRouter.route("/:id")
